...
[![Travis build status](https://travis-ci.com/ShulanSun/rTRIPLEX_CW_Flux.svg?branch=main)](https://travis-ci.com/ShulanSun/rTRIPLEX_CW_Flux)
<!-- badges: end -->
...
You can install the development version of rTRIPLEXCWFlux from [GitHub](https://github.com/) with:
...
This is a basic example which shows you how to run the package.
...
The outputs of the `TRIPLEX_CW_Flux` function are a long format dataframe and charts of simulated result for net ecosystem productivity (NEP) and evapotranspiration (ET) at 30 min scale, and monthly variation of the input environmental factors.
