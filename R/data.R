...
#'   \item{Month}{the number of month. E.g."1".}
#'   \item{Day}{the day of month. E.g."1".}
#'   \item{year}{studied year. E.g."2019".}
#'   \item{time}{the time of day at 30 min scale (h)}
#'   \item{DOY}{day of year. E.g."1"}
...
#' \describe{
#'   \item{Hw}{the height at wind measurement (m)}
